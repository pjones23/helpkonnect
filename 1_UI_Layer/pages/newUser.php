...
<div data-role="content" style="text-align:center">
	...
	<div id="newUser_PayPalOption" data-role="fieldcontain">
		<fieldset data-role="controlgroup" data-type="horizontal">
			...
			<input id="newUser_yesPayPal" name="" value="YES" type="radio">
			<label for="newUser_yesPayPal"> Yes </label>
			<input id="newUser_noPayPal" name="" value="NO" type="radio">
	...
	<div data-role="fieldcontain" id="newUser_PayPayEmail">
		<fieldset data-role="controlgroup">
			...
			<input name="" id="newUser_PayPalEmail" placeholder="" value="" type="email">
		</fieldset>
	</div>
